...
class bs4Navwalker extends Walker_Nav_Menu
{
    ...
    public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        if ($depth === 0 && in_array('menu-item-has-children', $classes)) {
            ...
            $atts['id']           =  $item->post_type . $item->ID;
        }
        ...
        if (in_array('menu-item-has-children', $classes)) {
            if($depth > 0){
                $item_output .= '<span class="dropdown-toggle" data-toggle="dropdown-submenu"><i class="fa fa-angle-down"></i></span>';
            }else{
                $item_output .= '<span class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-angle-down"></i></span>';
            }

            $item_output .= '<a class="nav-link "' . $attributes .'data-toggle="">';
